...
// payload.
func NewQueryResourcesPayload(version string, name *string, parent *string, type_ *string, tags []string, tagsAll []string, dateField *string, dateFrom *string, dateTo *string, filters []string, filtersAll []string, filtersOr []string, celFilter *string, sort string, pageToken *string, pageSize int, bearerToken string) *querysvc.QueryResourcesPayload {
