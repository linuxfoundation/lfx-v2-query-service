...
// NewQueryResourcesCountResultOK builds a "query-svc" service
...
// ValidateQueryResourcesCountResponseBody runs the validations defined on
// Query-Resources-CountResponseBody
